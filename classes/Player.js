...
class Player {
  ...
  switchSprites() {
    if (
      this.isOnGround &&
      (this.velocity.x === 0) & (this.currentSprite !== this.sprites.idle)
    ) {
      // Idle
      this.currentFrame = 0;
      this.currentSprite = this.sprites.idle;
      ...
      this.isOnGround &&
      (this.velocity.x !== 0) & (this.currentSprite !== this.sprites.run)
    ) {
      // Run
      this.currentFrame = 0;
      ...
      !this.isOnGround &&
      (this.velocity.y < 0) & (this.currentSprite !== this.sprites.jump)
    ) {
      // Jump
      this.currentFrame = 0;
      ...
      !this.isOnGround &&
      (this.velocity.y > 0) & (this.currentSprite !== this.sprites.fall)
    ) {
      // Fall
      this.currentFrame = 0;
